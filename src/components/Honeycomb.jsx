...
export function Honeycomb({ centerLetter, outerLetters, validLetters,
    addLetter, removeLetter, checkGuess
    ...
    return (
        <>
            <article className="honeycomb">
                ...
                <Letter letter={outerLetters[randomArray[0]]} isCenter={false}
                addLetter={addLetter}
                ></Letter>
                <Letter letter={outerLetters[randomArray[1]]} isCenter={false}
                addLetter={addLetter}
                ></Letter>
                <Letter letter={outerLetters[randomArray[2]]} isCenter={false}
                addLetter={addLetter}
                ></Letter>
                <Letter letter={outerLetters[randomArray[3]]} isCenter={false}
                addLetter={addLetter}
                ></Letter>
                <Letter letter={outerLetters[randomArray[4]]} isCenter={false}
                addLetter={addLetter}
                ></Letter>
                <Letter letter={outerLetters[randomArray[5]]} isCenter={false}
                addLetter={addLetter}
                ></Letter>
            </article>
